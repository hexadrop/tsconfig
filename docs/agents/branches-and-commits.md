...
**Examples:** `feat/fluid-heading-token`, `fix/missing-theme-variable`, `docs/api-reference`, `release/1.1.0`, `hotfix/fix-publish`
...
- `pre-push`: runs `bun run test`, `bun run lint:fix`, and `bun run typecheck`

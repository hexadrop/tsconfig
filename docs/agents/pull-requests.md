...
1. Open an issue using the [Bug Report](https://github.com/hexadrop/tsconfig/issues/new?template=bug_report.yml) or [Feature Request](https://github.com/hexadrop/tsconfig/issues/new?template=feature-request.yml) template.
